        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMPLOYEE_PERSON_JMB = table.Column<string>(type: "char(13)", fixedLength: true, maxLength: 13, nullable: false, collation: "utf8mb3_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb3"),
                    COMPANY_PROFILE_ID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => new { x.Employed_from, x.WORK_PLACE_ID, x.EMPLOYEE_PERSON_JMB, x.COMPANY_PROFILE_ID })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_employed = table.Column<sbyte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMPLOYMENT_EMPLOYEE_PERSON_JMB = table.Column<string>(type: "char(13)", fixedLength: true, maxLength: 13, nullable: false, collation: "utf8mb3_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb3"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.EMPLOYMENT_Employed_from, x.EMPLOYMENT_WORK_PLACE_ID, x.EMPLOYMENT_EMPLOYEE_PERSON_JMB, x.EMPLOYMENT_COMPANY_PROFILE_ID },
                        principalTable: "employment",
                        principalColumns: new[] { "Employed_from", "WORK_PLACE_ID", "EMPLOYEE_PERSON_JMB", "COMPANY_PROFILE_ID" });
                })
                .Annotation("MySql:CharSet", "utf8mb3")
                .Annotation("Relational:Collation", "utf8mb3_general_ci");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "salary",
                columns: new[] { "EMPLOYMENT_Employed_from", "EMPLOYMENT_WORK_PLACE_ID", "EMPLOYMENT_EMPLOYEE_PERSON_JMB", "EMPLOYMENT_COMPANY_PROFILE_ID" });
